...
// Database server
define('DB_ADDR', 'mssql:' . getenv('DB_PORT'));
// Database login
...
define('DB_ACC', getenv("DB_ACCOUNT_DATABASE"));
define('DB_GAM', getenv("DB_GAMEDB_DATABASE"));
define('DB_CCA', getenv("DB_CABALCASH_DATABASE"));
define('DB_CSH', getenv("DB_CABALCASH_DATABASE"));
